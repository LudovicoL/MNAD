...
class Memory(nn.Module):
    ...
    def forward(self, query, keys, train=True):
        ...
        # print("#############: query {}, {}".format(type(query), query.shape))
        # print("#############: keys {}, {}".format(type(keys), keys.shape))
        ...
        # print("#############: query2 {}, {}".format(type(query), query.shape))
        # sys.exit()
        #train
        if train:
            #losses
    ...
    def gather_loss(self,query, keys, train):
        ...
        if train:
            ...
            # print("gathering_indices: {}, {}".format(gathering_indices, gathering_indices.shape))
            # print("keys[gathering_indices]: {}".format(keys[gathering_indices].shape))
            # print("query_reshape: {}, keys[gathering_indices].squeeze(1).detach(): {}".format(query_reshape.shape, keys[gathering_indices].squeeze(1).detach().shape))
