...
class convAE(torch.nn.Module):
    ...
    def forward(self, x, keys,train=True):
        # print("#############: x {}, {}".format(type(x), x.shape))
        # print("#############: keys {}, {}".format(type(keys), keys.shape))
        fea, skip1, skip2, skip3 = self.encoder(x)
        # print("#############: fea {}, {}".format(type(fea), fea.shape))
        # print("#############: skip1 {}, {}".format(type(skip1), skip1.shape))
        # print("#############: skip2 {}, {}".format(type(skip2), skip2.shape))
        # print("#############: skip3 {}, {}".format(type(skip3), skip3.shape))
